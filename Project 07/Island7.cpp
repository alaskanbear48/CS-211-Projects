...
//Default Constructor, Calls MyList Def. Constructor
MyQueue::MyQueue()
	:MyList()
	{ }
...
void MyQueue::insertQ(int value)
{
	insertBack(value);
}
...
void MyStack::insertSK(int value)
{
	insertFront(value);
}
	
//Pop Node at the front of list 
int MyStack::popSK()
{
	return popFront();
}
...
bool MyStack::emptySK()
{
	return isEmpty();
}

//Show Values in Link List Stack 
void MyStack::showSK()
{
	show();
}
...
//Insert Node at front of the list 
void MyList::insertFront(int value)
{
...
void MyList::insertBack(int value)
{
