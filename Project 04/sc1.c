 ...
 while ((ch = getNextNWSChar ()) != EOF)
   {
    ...
    if ('q' == ch)
      ...
      {
       Head = doAdd(Head);//Call Function that Returns Head 
      } 
    else if('c' == ch)
      {
       Head = doCallAhead(Head);//Call Function that Returns Head 
      } 
    else if('w' == ch)
      {
       Head = doWaiting(Head);//Call Function that Returns Head 
      } 
    else if('r' == ch)
      {
       Head = doRetrieve(Head);//Call Function that Returns Head 
      } 
    else if('l' == ch)
      {
       doList(Head);
